...
const reservaSchema = new mongoose.Schema({
  ...
  inicio: { type: String, required: true, match: /^([01]?[0-9]|2[0-3]):[0-5][0-9]$/ },
  final: { type: String, required: true, match: /^([01]?[0-9]|2[0-3]):[0-5][0-9]$/ },
  usuario: { type: String, required: true },
  sigla_del_curso: { type: String, required: true },
